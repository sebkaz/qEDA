...
| `scripts/04_iris/` | Cross-fitted Iris audit, model-error and classification-boundary case typology, random-coupling/Haar controls, and sensitivity grid. |
...
.venv/bin/python scripts/04_iris/classification_boundary_cases.py
